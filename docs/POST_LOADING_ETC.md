# Papers Post — 비-arXiv 소스 로딩 가이드

> arXiv 외 학술 소스(Nature, IEEE, ACM 등)에서 Papers 포스트를 생성할 때의 차이점과 절차를 정리한다.
> 공통 파이프라인/스키마/MDX 구조는 `docs/POST_GENERATOR_PAPERS.md` 참조.
...
- **meta.json 스키마**: `POST_GENERATOR_PAPERS.md`의 메타데이터 스키마와 동일
...
- **후처리 스크립트**: `node /Users/terrytaewoongum/Codes/personal/terryum-ai/scripts/generate-index.mjs`, `node /Users/terrytaewoongum/Codes/personal/terryum-ai/scripts/copy-post-images.mjs`
- **빌드 검증**: `cd /Users/terrytaewoongum/Codes/personal/terryum-ai && rm -rf .next && npm run build`
...
### 5. 검증
- [ ] `node /Users/terrytaewoongum/Codes/personal/terryum-ai/scripts/generate-index.mjs` 성공
- [ ] `node /Users/terrytaewoongum/Codes/personal/terryum-ai/scripts/copy-post-images.mjs` 성공
